...
$("#city").keyup(function(event) {
	...
	$( "#submit-btn" ).click(function() {
		...
		//get data from the weather api based on the city name
		 max=[];
		 min=[];
		 icon=[];
		 humidity=[];
	...
	//display data based on location of the visitor
		
       $.getJSON("https://api.openweathermap.org/data/2.5/forecast/daily?lat="+lat+"&lon="+lon+"&cnt=7&appid=4882b61b9d6fa08f532b9197d4cb15a0", function(data) { 
		...
		$("#main_temp h3").append(city+", <span>"+country+"</span>");
